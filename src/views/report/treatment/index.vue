<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="treatmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="诊治ID" align="center" prop="diagId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['report:treatment:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
